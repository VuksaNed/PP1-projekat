...
public class GlobalVarDeclComma extends GlobalVarDeclComm {

    private VarDeclGlobalName VarDeclGlobalName;

    public GlobalVarDeclComma (VarDeclGlobalName VarDeclGlobalName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalVarDeclComma(\n");
