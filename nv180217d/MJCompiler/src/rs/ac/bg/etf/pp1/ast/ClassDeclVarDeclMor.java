...
public class ClassDeclVarDeclMor extends ClassDeclVarDeclMore {

    private VarDeclList VarDeclList;
    private ClassVarDecl ClassVarDecl;

    public ClassDeclVarDeclMor (VarDeclList VarDeclList, ClassVarDecl ClassVarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclVarDeclMor(\n");
