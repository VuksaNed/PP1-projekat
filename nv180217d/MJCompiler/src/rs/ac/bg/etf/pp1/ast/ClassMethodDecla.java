...
public class ClassMethodDecla extends ClassMethodDecl {

    private ClassMethodDecl ClassMethodDecl;
    private MethodDecl MethodDecl;

    public ClassMethodDecla (ClassMethodDecl ClassMethodDecl, MethodDecl MethodDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassMethodDecla(\n");
